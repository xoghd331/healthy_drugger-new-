				...
				<td>
					<table width="700" border="3" bordercolor="lightgray" align="center" >
							...
							<tr>
								...
								<td><input name="b_title" type="text" size="60" maxlength="100" value = "<%=dto.getB_title() %>"></td>
							</tr>
							<tr>
								<td id="title" style="padding-left:0px; padding-top:0px" width=65 style="word-break:break-all">내 용</td>
								<td><textarea name="b_content" cols="65" rows="20" style="resize:none;"><%=dto.getB_content() %></textarea></td>
							</tr>
						</table>
					</td>
					</tr> <!-- 행 -->
