			...
			<nav id="nav">
				<ul>
					...
					<li>
						<a href="#">커뮤니티</a>
						<ul>
							<li><a href="List3.jsp">자유게시판</a></li>
													...
													<div class="content">
														...
														<!-- 자유게시판에서 몇가지 내용 보여주기 : Featured Post -->
															<article class="box post">
																...
																<button type="button" class="button" onclick="location='Write3.jsp'">글쓰러 가기</button>
																<!-- <input type = button value = "글쓰기" onclick = "location='Write.jsp'">
																  <a href="#" class="button">글쓰러 가기</a>
																-->
																<button type="button" class="button" onclick="location='List3.jsp' ">게시판으로 이동</button>
															</article>
